        ...
        <div class="row m-bottom-30">
            <div class="col">
                <div class="d-flex justify-content-between flex-wrap">
                    <div>
                        <h1 class="fw-bold mb-0">Playlists</h1>
                    </div>

                    <div>
                        <a class="btn btn-primary-color" href="{{ route('playlists.create') }}">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @forelse ($playlists as $playlist)
                                    <tr class="fs-12">
                                        <td class="align-middle">{{ $playlists->firstItem() + $loop->index }}</td>
                                                ...
                                                <ul class="dropdown-menu rounded-10 fs-14">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('playlists.show', $playlist->id) }}"><i
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center text-color-100">
                                            <i class="las la-play-circle fs-48"></i>
                                            <p class="fs-14 fw-medium mt-1 mb-0">No Playlist Found!</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
            ...
            <div class="modal-content rounded-10">
                ...
                <div class="modal-body">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <h6 class="fw-semibold m-bottom-5">Delete Playlist</h6>
                        <p class="fs-14">Are you sure you want to delete this playlist?</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-border" data-bs-dismiss="modal">Cancel</button>
                    <form action="{{ route('playlists.destroy', $playlist->id) }}" method="post" id="deleteForm">
                        @method('delete')
                        @csrf
