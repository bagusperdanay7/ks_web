        ...
        <div class="row m-bottom-30">
            <div class="col">
                <div class="d-flex justify-content-between flex-wrap">
                    <div>
                        <h1 class="fw-bold">Project Artist</h1>
                    </div>

                    <div>
                        <a class="btn btn-primary-color" href="{{ route('project-artist.create') }}">
                ...
                <div class="table-container">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @forelse ($projectArtist as $project)
                                    @foreach ($project->artists as $item)
                                        <tr class="fs-12">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-color-100">
                                            <i class="las la-user-friends fs-48"></i>
                                            <p class="fs-14 fw-medium mt-1 mb-0">No Project Artist Found!</p>
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
            ...
            <div class="modal-content rounded-10">
                ...
                <div class="modal-body">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <h6 class="fw-semibold m-bottom-5">Delete Project Artist</h6>
                        <p class="fs-14">Are you sure you want to delete this?</p>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light-border" data-bs-dismiss="modal">Cancel</button>
                    <form action="{{ route('project-artist.destroy', $project->id ?? '') }}" method="post" id="deleteForm">
                        @method('delete')
                        @csrf
