        ...
        <div class="row m-bottom-30">
            <div class="col">
                <div class="d-flex justify-content-between flex-wrap">
                    ...
                    <div>
                        <a class="btn btn-primary-color" href="{{ route('companies.create') }}">
                                                ...
                                                <ul class="dropdown-menu rounded-10 fs-14">
                                                    ...
                                                    <li>
                                                        <button class="dropdown-item button-delete" type="button"
                                                            ...
                                                            data-id="{{ $company->id }}"
                                                            data-title="{{ $company->name }}"><i
                                                                class="las la-trash-alt"
                                                                id="buttonDelete{{ $company->id }}"></i>
                                                            Delete</button>
                                                    </li>
                                                </ul>
                                            </div>
            ...
            <div class="modal-content rounded-10">
                ...
                <div class="modal-body">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <h6 class="fw-semibold m-bottom-5">Delete Company</h6>
