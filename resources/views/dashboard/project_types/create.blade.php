                    ...
                    <form method="post" action="{{ route('project-types.store') }}">
                        ...
                        <div class="m-bottom-15">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" name="slug"
                                id="slug" value="{{ old('slug') }}" aria-label="slug input Readonly" readonly>
                            @error('slug')
                        ...
                        <div class="m-bottom-15">
                            ...
                            <textarea class="form-control @error('about') is-invalid @enderror" id="about" rows="3" name="about" placeholder="Enter Project Type About">{{ old('about') }}</textarea>
                            @error('about')
