                        ...
                        <form action="{{ route('request-form-post') }}" method="post" class="mt-30 col-12 p-0">
                            ...
                            <div class="mb-15">
                                <label for="project_title" class="form-label fs-18 fw-medium text-color-100">Project
                                    Title</label>
                                <input type="text"
                                    class="form-control @error('project_title') is-invalid @enderror @error('password') is-invalid @enderror"
                            ...
                            <div class="mb-15">
                                ...
                                <input type="text"
                                    class="form-control @error('requester') is-invalid @enderror @error('password') is-invalid @enderror"
